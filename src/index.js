...
import { createMainDiv, createButtonsForEachProjectOnSidebar, createHeader, displayProjects, addNewToDoBtn } from "./UI";
...
const thirdToDo = createToDo("Buy cat food", "Buy some kitekat", "04-05-2024", "very imortant");
